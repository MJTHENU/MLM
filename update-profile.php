...
if (isset($_POST['submit'])) {
 ...
 // $gender = $_POST['gender'];
  ...
  $query = "UPDATE user SET name = '".$name."', mobile = '".$mobile."', address = '".$address."', city= '".$city."', district = '".$district."', state = '".$state."', pincode = '".$pincode."', doj = '".$doj."', dou = '".$dou."', bank = '".$bank."', account_no = '".$accno."', ifsc_code = '".$ifsc."', branch = '".$branch."' where email = '".$userid."'";
  if (mysqli_query($con,$query) === TRUE) {
    // Profile saved successfully
    $con->close();
    echo '<script>alert("Profile Saved successfully");window.location.assign("update-profile.php");</script>';
    exit();
  } else {
...
<head>
    ...
    <title>Mlm Website - Update Profile</title>
...
<div class="form-container">
    ...
    <div class="form-group col-md-4">
      ...
      <div class="form-group col-md-4">
        ...
        <input type="text" id="username" name="username" value="<?php echo $result["email"] ?>" disabled>
      </div><div class="form-group col-md-4">
        <label for="name">Mobile:</label><br>
        <input type="text" id="mobile" name="mobile" value="<?php echo $result["mobile"] ?>" required>
      </div><div class="form-group col-md-9">
        <label for="name">Address:</label><br>
        <textarea type="text" id="address" name="address" required style="width:100%"><?php echo $result['address'] ?></textarea>
      </div><div class="form-group col-md-4">
        ...
        <input type="text" id="district" name="district" value="<?php echo $result["district"] ?>" required>
      </div><div class="form-group col-md-4">
        <label for="name">State:</label><br>
        <input type="text" id="state" name="state" value="<?php echo $result["state"] ?>" required>
      </div><div class="form-group col-md-4">
        <label for="name">Pincode:</label><br>
        <input type="text" id="pincode" name="pincode" value="<?php echo $result["pincode"] ?>" required>
      </div><div class="form-group col-md-4">
        <label for="name">Date of Join:</label><br>
        <input type="text" id="doj" name="doj" value="<?php echo $result["doj"] ?>" required>
      
      </div><div class="form-group col-md-4">
        <label for="name">Date of Update:</label><br>
        <input type="text" id="dou" name="dou" value="<?php echo $result["dou"] ?>" required>
      </div>
      <div class="form-group col-md-4">
        <label for="name">Bank Name:</label><br>
        <input type="text" id="bank" name="bank" value="<?php echo $result["bank"] ?>" required>
      </div>
      <div class="form-group col-md-4">
        <label for="name">Bank Account No:</label><br>
        <input type="text" id="accno" name="accno" value="<?php echo $result["account_no"] ?>" required>
      </div>
      <div class="form-group col-md-4">
        <label for="name">IFSC Code:</label><br>
        <input type="text" id="ifsc" name="ifsc" value="<?php echo $result["ifsc_code"] ?>" required>
      </div>
      <div class="form-group col-md-4">
        <label for="name">Branch:</label><br>
        <input type="text" id="branch" name="branch" value="<?php echo $result["branch"] ?>" required>
      </div>
      <div class="form-group col-md-4">
